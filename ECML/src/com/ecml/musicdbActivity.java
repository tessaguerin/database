...
private titleDataSource datasource;
  ...
  private choose_difficulty selectDifficulty;
...
case R.id.by_difficulty:
	Intent goToChooseDifficulty = new Intent(getApplicationContext(),
			choose_difficulty.class);
			startActivity(goToChooseDifficulty);
